...
router.get('/', function (req, res, next) {
    ...
    axios.all([
        axios.get('http://localhost:8080/districts'
            + '?disease=' + (req.query.disease === undefined ? encodeURIComponent('ВИЧ') : encodeURIComponent(req.query.disease))
            + (req.query.district === undefined ? '' : '&district=' + encodeURIComponent(req.query.district))),
